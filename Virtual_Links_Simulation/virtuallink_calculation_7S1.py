...
# case 2 : VL2
# VL7 -> VL2 -> VL3 -> VL9 -> switch B (VL7)to A -> VL6 -> VL13 -> VL5 -> VL12 -> switch A (VL7) to ES1
...
t10 = switchA_to_ES1.bind_task(model.Task("T4", wcet=14, bcet=1, scheduling_parameter=2))
