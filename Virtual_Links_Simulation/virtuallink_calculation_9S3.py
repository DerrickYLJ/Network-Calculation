...
# case 2 : VL2
# VL9 -> VL2 -> VL3 -> VL7 -> switch B (VL9)to A -> VL6 -> VL13 -> VL4 -> VL8 -> VL11 -> switch A (VL9) to ES3
...
t11 = switchA_to_ES1.bind_task(model.Task("T4", wcet=121, bcet=1, scheduling_parameter=2))
